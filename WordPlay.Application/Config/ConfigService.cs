...
namespace WordPlay.Service.Config
{
    public class ConfigService : IConfigService
    {
        ...
        /// {1} : PanelId
        /// </remarks>
        public const string CONFIG_KEYBY_CAMPAIGN_PANELID = "wordplay.config.bycampaign&panelid-{0}-{1}";
        ...
        /// {0} : CampaignKey
        /// </remarks>
        public const string CONFIG_KEYBY_CAMPAIGN = "wordplay.config.bycampaign-{0}";


        public const string CONFIG_PATTERN_KEY = "wordplay.config";
