...
using AutoMapper;
using WordPlay.Model.Gaas.Models;
using WordPlay.Model.GaasModels;
...
namespace WordPlay.Service.Consumer
{
    public class ConsumerService : IConsumerService
    {
        ...
        /// {1} : GaasConsumerId
        /// </remarks>
        public const string CONSUMER_KEYBY_CAMPAIGN_GAASCONSUMERID = "wordplay.consumer.bygaasInfo-{0}-{1}";


        public const string CONSUMER_PATTERN_KEY = "wordplay.consumer";
